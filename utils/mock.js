  ...
  var list = [
    {
      ...
      "endTime": "2018/10/15 00:00:00", //结束时间，注意格式
    },
    {
      "id": 2,  //id	
      "merchantId": 1,  //商户ID	
...
function QueryGroupPurchaseDetail() {
  var data = {
    "detail": {
      "id": 1,  //id	
      "pics": [
        "https://s-mall.oss-cn-beijing.aliyuncs.com/meichao/g3.png?Expires=1539012849&OSSAccessKeyId=TMP.AQFuX_j98e_3qsZzg3d4_FGRpIhNvxzWdja7QuEmrjTTfZY5ImRd32kGn8hRAAAwLAIUSu5CvcEY5uFZX519SiYa1ut1bdMCFBCSZRZpA8XsM_SDI-lhQErO1dwf&Signature=vN8WCylWwGlu%2BffYxlw1Q40X3BA%3D",
        "https://s-mall.oss-cn-beijing.aliyuncs.com/meichao/g3.png?Expires=1539012849&OSSAccessKeyId=TMP.AQFuX_j98e_3qsZzg3d4_FGRpIhNvxzWdja7QuEmrjTTfZY5ImRd32kGn8hRAAAwLAIUSu5CvcEY5uFZX519SiYa1ut1bdMCFBCSZRZpA8XsM_SDI-lhQErO1dwf&Signature=vN8WCylWwGlu%2BffYxlw1Q40X3BA%3D"
      ],  //商品展示图片
      ...
      "limitNum": 99, //参团人数上限
      "startTime": "2018/10/05 00:00:00", //开始时间，注意格式
      "endTime": "2018/10/06 00:00:00", //结束时间，注意格式
      "joinNum": 9, //参团人数
    },
    "merchant": {
      "merchantId": 1,  //商户ID
